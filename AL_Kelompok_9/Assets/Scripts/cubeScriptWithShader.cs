...
public class cubeScriptWithShader : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        uvs[8] = new Vector2(0.0f, 0.25f);
        uvs[9] = new Vector2(0.0f, 0.5f);
        uvs[10] = new Vector2(0.25f, 0.25f);
        ...
        uvs[12] = new Vector2(0.25f, 0.25f);
        uvs[13] = new Vector2(0.25f, 0.5f);
        uvs[14] = new Vector2(0.25f, 0.50f);
        uvs[15] = new Vector2(0.5f, 0.50f);
        ...
        uvs[18] = new Vector2(0.0f, 0.75f);
        uvs[19] = new Vector2(0.25f, 0.75f);
        ...
        uvs[20] = new Vector2(0.25f, 0.5f);
        uvs[21] = new Vector2(0.5f, 0.5f);
        uvs[22] = new Vector2(0.5f, 0.75f);
        uvs[23] = new Vector2(0.25f, 0.75f);    

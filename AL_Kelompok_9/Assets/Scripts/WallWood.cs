...
public class WallWood : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        uvs[14] = new Vector2(0.25f, 1.0f);
        uvs[15] = new Vector2(0.5f, 1.0f);
        ...
        uvs[18] = new Vector2(0.25f, 1.0f);
        uvs[19] = new Vector2(0.5f, 1.0f);
        ...
        uvs[22] = new Vector2(0.25f, 1.0f);
        uvs[23] = new Vector2(0.5f, 1.0f);
